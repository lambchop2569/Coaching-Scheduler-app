...
async function upRequest(body) {
    if (!UPSTASH_URL)
        throw new Error('Upstash URL not configured');
...
export async function upGetSchedulerData() {
...
export async function upSetSchedulerData(data) {
    if (!UPSTASH_AVAILABLE)
        return false;
    try {
...
export async function upGetAppointments() {
    if (!UPSTASH_AVAILABLE)
        return null;
    try {
...
export async function upSetAppointments(sessions) {
    if (!UPSTASH_AVAILABLE)
        return false;
    try {
